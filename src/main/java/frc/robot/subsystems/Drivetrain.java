...
public class Drivetrain extends SubsystemBase {
  ...
  public Drivetrain() {
    ...
    // Encoder leftEncoder = new Encoder(1, 1);
  ...
  public void periodic() {
    ...
    // m_odometry.update(m_navX.getRotation2d(), leftEncoder.getDistance(), rightEncoder.getDistance());
    // SmartDashboard.putNumber("Left Encoder distance meters", getLeftEncoderDistance());
    // SmartDashboard.putNumber("Right Encoder distance meters", getRightEncoderDistance()); 
